      ...
      <section id="experience" style={{ backgroundColor: "#0d1225" }}>
        <div className="px-6 md:px-20 py-24 max-w-6xl mx-auto">
          <Reveal>
            ...
            <div>
              {[
                { role: "Technology Intern", org: "PNC Bank", date: "Jun 2026 — Present", location: "Pittsburgh, PA", bullets: ["🏆 Designed pitch deck for product competition — selected as a finalist", "Built a Microsoft Copilot AI assistant to streamline data analysis and project work.", "Designed Power BI dashboards with SharePoint and Power Automate to drive business insights."] },
